...
const Task = ({ task, provided }) => {
  ...
  return (
    <div
      ...
      className="w-[290px] max-w-[300px] cursor-grab border border-sky-500 bg-[#fafafa] flex flex-col justify-between gap-3 items-start shadow-sm rounded-xl px-3 py-4"
    >
      {image && alt && (
